...
const ALL_PRODUCTS = [
  ...
  { id:"BX-23", name:"鳳凰之翼", nameEn:"PhoenixWing", code:"BX-23", series:"BX",
    blade:{id:"phoenixwing",name:"鳳凰之翼",nameEn:"PhoenixWing",type:"attack"},
  ...
  // ── UX Unique Line ──
  { id:"UX-01", name:"龍爆擊", nameEn:"DranBuster", code:"UX-01", series:"UX",
    blade:{id:"dranbuster",name:"龍爆擊",nameEn:"DranBuster",type:"attack"},
  ...
  { id:"UX-15", name:"鯊魚鱗套組", nameEn:"SharkScale Deck Set", code:"UX-15", series:"UX",
    blade:{id:"sharkscale",name:"鯊魚鱗",nameEn:"SharkScale",type:"attack"},
